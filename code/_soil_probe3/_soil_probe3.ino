/*
 * Soil Moisture Probe 3 (battery powered)
 * 
...
//radio network
  ...
  radio.setPALevel(RF24_PA_LOW); //might want to decrease power requirements; LOW used to be MIN
...
//sending data
  ...
  payload_t payload = {0, 0, 0, 0, 0, 0, 0, 0, 0, soil, Volts};
